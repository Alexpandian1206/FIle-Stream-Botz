...
async def start_command(client, message):
    ...
    if msg.startswith("file"):
        ...
        Rishi = await client.copy_message(chat_id=message.from_user.id, from_chat_id=int(Var.BIN_CHANNEL), message_id=int(file_id), protect_content=Var.PROTECT_CONTENT)
